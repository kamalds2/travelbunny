                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 col-xs-6">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="menu_icon" id="flexRadioDefault1" value="noicon" <?php if($this->menuDetails['menu_icon'] == 'noicon') echo "checked"; ?> >
                                                ...
                                                <div class="col-sm-3 col-xs-6">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="menu_icon" id="flexRadioDefault2" value="reload" <?php if($this->menuDetails['menu_icon'] == 'reload') echo "checked"; ?> >
                                                ...
                                                <div class="col-sm-3 col-xs-6">
                                                    <div class="form-check mb-2">
                                                        <input class="form-check-input" type="radio" name="menu_icon" id="flexRadioDefault3" <?php if($this->menuDetails['menu_icon'] == '') echo "checked"; ?> >
