    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="box">
          ...
          <div class="box-content frms" style="margin-top: 105px;">
           <form method="post" action="<?php echo SITEURL; ?>menus/addMenuDetails" class="form-horizontal row" id="validation-form" autocomplete="off">
           
           <div class="form-group col-lg-6">
                <label class="col-sm-12 col-lg-12 control-label">Menu Name</label>
                <div class="col-lg-12 controls">
                  <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-text-width"></i><strong>Menu Name<span>*</span></strong></span>
                ...
                <div class="form-group col-lg-6">
                <label class="col-sm-12 col-lg-12 control-label">Menu Parent</label>
                <div class="col-lg-12 controls">
              ...
              <div class="col-lg-6 mb-3">
                <label for="label" class="form-label">Content Type</label> 
                <select class="form-select" id="label" name="menu_contenttype" id="menu_contenttype" required>
              ...
              <div class="form-group col-lg-6">
                <label class="col-sm-12 col-lg-12 control-label">Select Content</label>
                <div class="col-lg-12 controls">
              ...
              <div class="form-group col-lg-12">
                <label class="col-sm-12 col-lg-12 control-label">Menu Icon</label>
                <div class="col-lg-12 controls">
               ...
               <div class="form-group col-lg-6">
                <label class="col-sm-12 col-lg-12 control-label">Menu Status</label>
                <div class="col-lg-12 controls">
...
$(document).ready(function () {
    ...
    $('#menu_contenttype').on('change', function(){      
      console.log("vijji");return;
      var option = $(this).val();
...
<!-- users,roles,dashboard,enquiries->contact form, pages  -> title, banner image, text editor.
slider : image,description, title -> add edit, dlt, menu
dashboard-> most lead packages,  enquiries : name,msg,mobile, email,occupation.
dashboard,sliders,pages,enquiries,users_mgmt
