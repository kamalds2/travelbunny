...
define('VERSION', '1.0');
define('MAINURL', $_SERVER['DOCUMENT_ROOT']."/travel_bunny/");
define("SITEURL", "http://" . $_SERVER['HTTP_HOST'] . '/travel_bunny/');
define("URL", "http://" . $_SERVER['HTTP_HOST'] . str_replace("index.php/", "", $_SERVER['REQUEST_URI']));
define('BASE', $_SERVER['DOCUMENT_ROOT']."/travel_bunny/");
define("RESTURL","http://" . $_SERVER['HTTP_HOST'] . '/travel_bunny/'."restful/");
define('PATH', "http://" . $_SERVER['HTTP_HOST'] ."/travel_bunny/");
